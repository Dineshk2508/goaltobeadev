...
class Student {
	...
	public static final int RECORD_SIZE = 4 + (2 * SFIELD_SIZE * 2);
	...
	public void show() {
		System.out.println("RollNum:" + rollNum + " Name: " + name + " Course:" + course);
	}
...
class DatIO {
	...
	static void writeString(String str, int size, DataOutput out) throws IOException {
		int i;
		for (i = 0; i < size; i++) {
			char ch = ' ';
			if (i < str.length()) {
